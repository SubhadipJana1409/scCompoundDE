...
#'
#' @importFrom ggplot2 ggplot aes geom_bar geom_jitter position_jitter position_stack position_dodge scale_fill_manual scale_color_manual labs theme_bw theme element_text element_blank facet_wrap
